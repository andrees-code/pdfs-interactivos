  ...
  <div class="template-sidebar-panel">
    ...
    <div class="tsp-body" v-show="templatePanelOpen">
      ...
      <!-- MIS PLANTILLAS -->
      <div class="tsp-my-templates-wrapper" ref="myTemplatesBtnRef">
        <button class="tsp-my-templates-btn" @click="myTemplatesOpen = !myTemplatesOpen">
          <i class="ph ph-folders"></i>
          <span>Mis plantillas</span>
          <i class="ph ph-caret-right" style="margin-left: auto; font-size: 0.7rem; opacity: 0.5;"></i>
        </button>

        <!-- MENÚ FLOTANTE -->
        <!-- BACKDROP + MENÚ FLOTANTE CENTRADO -->
  <teleport to="body">
    <div v-show="myTemplatesOpen" class="tsp-backdrop" @click="myTemplatesOpen = false">
      <div class="tsp-my-templates-popup" @click.stop>
        <div class="tmpl-popup-header">
          <i class="ph ph-folders"></i>
          Mis plantillas
          <button class="tmpl-close-btn" @click="myTemplatesOpen = false">
            <i class="ph ph-x"></i>
          </button>
        </div>
        <div class="tmpl-popup-body">
          <div class="tmpl-coming-soon">
            <i class="ph ph-rocket-launch"></i>
            <p>Próximamente</p>
            <small>Podrás guardar y reutilizar tus propios diseños.</small>
          </div>
        </div>
      </div>
    </div>
...
.tsp-toggle:hover { background: #161b22; color: #c9d1d9; }
  ...
  .tsp-toggle-left i { font-size: 1rem; color: #58a6ff; }
  ...
  .tsp-card.is-active { border-color: #58a6ff; background: rgba(88, 166, 255, 0.06); }
  ...
  .tsp-card:hover .tsp-preview { border-color: #58a6ff; }
  .tsp-card.is-active .tsp-preview { border-color: #58a6ff; }
  ...
  .tsp-preview-dark { background: #0d1117; }
  ...
  .tsp-card.is-active .tsp-name { color: #58a6ff; }

...
.ipm-title i { color: #58a6ff; font-size: 1.1rem; }
.ipm-close {
...
.ipm-close:hover { background: #21262d; color: #ff7b72; }
...
.ipm-search-wrap:focus-within { border-color: #58a6ff; box-shadow: 0 0 0 3px rgba(88,166,255,0.12); }
.ipm-search-icon { color: #8b949e; font-size: 1rem; flex-shrink: 0; }
.ipm-search {
  flex: 1;
  background: transparent;
  border: none;
...
.ipm-search-clear:hover { color: #ff7b72; }
...
.ipm-cat-pill:hover { border-color: #58a6ff; color: #c9d1d9; background: #161b22; }
...
.ipm-grid-wrap::-webkit-scrollbar-thumb { background: #30363d; border-radius: 3px; }
...
.ipm-empty p { margin: 0; font-size: 0.85rem; color: #8b949e; }
...
.ipm-preview i { font-size: 1.4rem; color: #58a6ff; flex-shrink: 0; }
.ipm-preview span {
  font-size: 0.78rem;
  color: #8b949e;
...
.ipm-confirm:hover { background: #2ea043; transform: translateY(-1px); box-shadow: 0 4px 12px rgba(46,160,67,0.35); }
